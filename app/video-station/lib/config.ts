...
export const MONGODB_CONFIG = {
  uri: process.env.MONGODB_URI || "mongodb+srv://Viper3:ShadowZed666@pythonproject.1rxku.mongodb.net/?retryWrites=true&w=majority&appName=PythonProject",
  dbName: process.env.DB_NAME || "XOVideos",
  colName: process.env.COL_NAME || "pornhub",
};
